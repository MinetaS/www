...
$i++;
$cfg['Servers'][$i]['host']          = $MYSQL_HOST; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = $MYSQL_ID;      // MySQL user
$cfg['Servers'][$i]['password']      = $MYSQL_PASSWORD;          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = $MYSQL_DB;          // If set to a db-name, only
