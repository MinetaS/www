...
<!--결재성공후 이동될페이지-->
<input type="hidden" name="RecognPage" value="http://www.bankwell.co.kr/pay_renew/modules/return_true.php">
<!--결재실패후 이동될페이지-->
<input type="hidden" name="ErrorPage"  value="http://www.bankwell.co.kr/pay_renew/modules/return_false.php">
