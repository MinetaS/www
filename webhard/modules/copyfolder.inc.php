 ...
 *
 *   Module
 *   $Id: copyfolder.inc.php,v 1.1 2005/07/26 21:55:09 andrewgodwin Exp $
 *
 */

#name Copy
#author Andrew Godwin
#description Copies folders
#iscore 1
...
if (bh_file_exists($filepath) == true) {
	...
	if ($_POST['newname']) {
	//echo "check A : ".$filepath;
		$destfilepath = bh_fpclean($infolder."/".$_POST['newname']);

		$fileobj = new bhfile2($filepath);
    //echo "fileobj : ".$fileobj."<br>";
		...
		$layoutobj = new bhlayout("copyfolderform");
