...
#name MySQL Database Module (ADOdb)
#author Andrew Godwin
#description Uses a MySQL (local or remote) database to store configuration.
#type database
#extension mysql
...
$dbconfigneeded = array(
	"host"=>array("type"=>"string", "name"=>"MySQL Hostname", "description"=>"The hostname of your MySQL server. If it's running on the same machine, this will be 'localhost'.", "default"=>"localhost"),
...
# Auto dynamic load. Just provide extension name.
bh_dl("mysql");
...
if ($result === FALSE) { $dbmoderror = ("MySQL Error: ".mysql_error()); return FALSE; }
