...
<table class='toolbar' cellspacing='0' cellpadding='0' width='75%' align='center'>
	...
	<tr>
		...
		<td valign='middle' align='center'><br><br>
			...
			".$bhlang['title:hasgrantedyou']." "."<br /><br />
			".$bhlang['explain:DZupload']."<br>
			<br><br>
			</td></tr>
			<form action='folderDZ.php?folderDZ=".$_GET['folderDZ']."' method='POST' enctype='multipart/form-data' name='uploadform'>
			<tr>
			<td align='center'>
			...
			<td align='center'>
				<input type='submit' value='".$bhlang['button:upload']."'>
			</td>
			</tr>
			</form>
			</table><br>
