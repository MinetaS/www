...
<table class='toolbar' cellspacing='0' cellpadding='0' width='70%' align='center'>
	...
	<tr>
		...
		<td valign='middle' align='center'><br><br>
			...
			".$bhlang['explain:move']."<br><br>
			<form action='index.php?page=choosefolder&returnto=move&returnfilepath=".$this->filepath."' method='POST'>
			".$bhlang['label:move_to'].$this->infolder." &nbsp; <input type='submit' value='".$bhlang['button:change_folder']."'>
			</form>
			<br><br>
			</td></tr>
			<form action='index.php?page=movefolder&infolder=".$this->infolder."&filepath=".$this->filepath."' method='POST'>
			<tr>
			<td align='center'>
				".$bhlang['label:new_name']."<input type='textbox' name='newname' value='".$this->content1."'>
			</td>
			<td align='center'>
				<input type='submit' value='".$bhlang['button:move']."'>
			</td>
			</tr>
			</form>
			</table><br><br>
