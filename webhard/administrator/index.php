 ...
 *
 *   Index.php
 *   $Id: index.php,v 1.5 2005/07/28 20:11:47 andrewgodwin Exp $
 *
 */
...
# Set that we're in the admin area
$bhconfig['inadmin'] = TRUE;
...
require "layout/main.inc.php";				# Layout file
...
if ($bhcurrent['userobj']->type != "admin") { bh_log($bhlang['notice:you_must_be_admin'], "BH_WARNING"); $_GET['page'] = "login"; }
...
if (file_exists("../install/index.php")){ echo "You should remove the install folder.";  }
